...
@Service
public class CommentUseCase implements CommentService {
        ...
        public CommentUseCase(CommentRepository commentRepository, BlogRepository blogRepository,
                        UserRepository userRepository, CommentMapper commentMapper, ToastIdGenerator toastIdGenerator) {
        ...
        public ApiResponse<Page<CommentResponse>> getCommentsByBlog(Integer idBlog, Pageable pageable) {
                ...
                Page<Comment> topLevelComments = commentRepository
                                .findParentCommentsByBlogId(idBlog,
                                                pageable);
